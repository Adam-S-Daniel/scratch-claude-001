...
The app consumes three types of data: auction house definitions, past auction sale records, and current art listings. All data is loaded as dictionaries (e.g., from JSON files or API responses).
